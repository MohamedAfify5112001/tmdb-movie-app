...
class GetTvTopRatedUseCase implements BaseTVUseCase<NoParameters, List<TV>> {
  final BaseTVSRepository tvsRepository;

  GetTvTopRatedUseCase(this.tvsRepository);

  @override
  Future<Either<Failure, List<TV>>> call(NoParameters noParameters) async {
    return await tvsRepository.getTopRatedTvs();
  }
}
